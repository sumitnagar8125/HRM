...
export default function About() {
  return (
    <div className="space-y-4 w-full px-0 sm:px-2">
      ...
      <div className="border rounded-md bg-white shadow-sm p-4 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-gray-700 text-sm">
              Empowering businesses through innovative technology solutions and exceptional service delivery.
            </p>
          </div>
          {/* Culture */}
          <div>
            ...
            <p className="text-gray-700 text-sm">
              Innovation, Integrity, Excellence – Building tomorrow’s technology today.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="border rounded-md bg-white shadow-sm p-4">
          ...
          <p className="text-sm">
            ...
            <a href="mailto:hr@zytexa.com" className="text-blue-600 hover:underline">
              hr@zytexa.com
            </a>
          </p>
          <p className="text-sm">
